...
class CreateBlogPage extends Component {
    ...
    saveEditorData = () => {
        return this.props.saveDataFromEditor(JSON.stringify(this.props.editorState), 
                                                            this.state.title, this.state.tags, 
                                                            this.props.user._id, 
                                                            this.props.user.username).then(response => {
            
            console.log('Save : ' + this.props.user._id)
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Row className={'editorBlock'} style={{background: '#f9f9f9' , marginTop: 120 , zIndex: 0}}>
